...
import styles from "./ExploreHistoryCardButton.module.css";

function ExploreHistoryCardButton({ variant, onClick, filled = false }) {
  const variants = {
    downvote: {
      icon: <FaTimes />,
...
export default ExploreHistoryCardButton;
